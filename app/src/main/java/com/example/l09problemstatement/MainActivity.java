package com.example.l09problemstatement;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGetLocation = (Button) findViewById(R.id.btnGetLocUpdate);
        btnRemoveLocationUpdate = (Button) findViewById(R.id.btnRemoveLocUpdate);
